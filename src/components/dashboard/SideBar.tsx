...
export const SideBar = () => {
    return (
        <>
            <div id='side-bar'
                 className='h-[100vh] w-60 fixed z-10 top-0 left-0 bg-white overflow-hidden flex flex-col  rounded-r-lg drop-shadow-xl'>
                ...
                <div className=''>
                    <Link className={'nav-btn-logout'} to='/logout'>Logout</Link>
                </div>
            </div>
        </>
    );
