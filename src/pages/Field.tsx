            ...
            <div className="ml-60 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-40 ml-4 ">
                    ...
                    <div className="bg-white rounded-lg  overflow-hidden shadow-2xl ">
                        <img src="src/assets/dashboardImg/Screenshot 2025-01-14 001410.png" alt="Field Image"
                             className="w-full h-40 object-cover"/>
                        <div className="p-4">
                            <p className="text-gray-600 text-sm font-semibold">Field Code</p>
                            <p className="text-gray-800 font-medium truncate">F-52d02329-a257-4854...</p>
                            <p className="text-gray-600 text-sm font-semibold mt-2">Field Size</p>
                            <p className="text-gray-800 font-medium">45P</p>
                            <p className="text-gray-600 text-sm font-semibold mt-2">Field Name</p>
                            <p className="text-lg font-semibold text-gray-900">Kurundu</p>
                        </div>
                        <div className="flex items-center justify-center ">
                            <div className="flex flex-row items-center gap-4 action mb-2">
                ...
                {/*popup add staff*/}
                {PopupSaveVisible && <FieldSavePopUp onClose={() => setShowSave(false)}/>}
                {PopUpUpdateVisible && <FieldUpdatePopUp onClose={() => setShowUpdate(false)}/>}
                {PopUpViewStaffVisible && <ViewFieldPopUp onClose={() => setShowViewStaff(false)}/>}
