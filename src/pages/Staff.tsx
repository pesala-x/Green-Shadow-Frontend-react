            ...
            <div className="ml-60 text-center">
                ...
                <div className=" flex mt-40 ml-4 ">
                    <div className="">
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-24 ml-4 '>
                            <div className="" id="staffTableBody">
                                {/*added*/}
                                <div className='bg-white rounded-lg  overflow-hidden shadow-2xl'>
                                    <div className="px-10 py-4">
                                        <p className="text-gray-600 text-sm font-semibold">Staff Id</p>
                                        <h5 className="text-gray-800 font-medium truncate">ST5bc69960-9406-44ec...</h5>
                                        <p className="text-gray-600 text-sm font-semibold mt-2">Name</p>
                                        <h5 className="text-gray-800 font-medium">John Doe</h5>
                                        <p className="text-gray-600 text-sm font-semibold mt-2">Gender</p>
                                        <h5 className="text-gray-800 font-medium">Male</h5>
                                        <p className="text-gray-600 text-sm font-semibold mt-2">Contact</p>
                                        <h5 className="text-sm mb-1 font-semibold text-gray-900">1234567890</h5>
